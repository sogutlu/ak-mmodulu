...
void receive_init()
{
    ...
    // default setup 
    spi_data[0]=0b00001000;
    spi_write(spi_data,CONFIG,1);
    
    spi_data[0]=0b00111111;
    spi_write(spi_data,EN_AA,1); 
    
    spi_data[0]=0b00000011;
    spi_write(spi_data,EN_RXADDR,1);
    
    spi_data[0]=0b00000011;
    spi_write(spi_data,SETUP_AW,1);
    
    spi_data[0]=0b00000011;
    spi_write(spi_data,SETUP_RETR,1);
    
    spi_data[0]=0b00000010;
    //spi_write(spi_data,RF_CH,1);// düzenlendiği için uyutuluyor
    
    spi_data[0]=0b00001110;
    spi_write(spi_data,RF_SETUP,1);
    
    spi_data[0]=0b00001110;
    spi_write(spi_data,STATUS,1);
    
    spi_data[0]=0b00000000;
    //spi_write(spi_data,OBSERVE_TX,1);// read only
    
    spi_data[0]=0b00000000;
    //spi_write(spi_data,RPD,1); // read only
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P0,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P1,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P2,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P3,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P4,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,RX_PW_P5,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,FIFO_STATUS,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,FIFO_STATUS,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,DYNPD,1);
    
    spi_data[0]=0b00000000;
    spi_write(spi_data,FEATURE,1);
